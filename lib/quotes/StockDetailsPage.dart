...
class StockDetailsPage extends StatefulWidget {
  ...
  StockDetailsPage({Key key, this.enity}) : super(key: key);
...
class StockDetailsPageState extends State<StockDetailsPage>
  ...
  void initData() {
    ...
    //分时线的查询：
    String minKimgUrl = "http://image.sinajs.cn/newchart/min/n/" +
        stock_code2.toString() +
        ".gif";
    //周K线查询：
    String weeklyKimgUrl = "http://image.sinajs.cn/newchart/weekly/n/" +
        stock_code2.toString() +
        ".gif";
    //月K线查询：
    String monthlyKimgUrl = "http://image.sinajs.cn/newchart/monthly/n/" +
        stock_code2.toString() +
        ".gif";
    _allPages = <_Page>[
      _Page("分时", minKimgUrl),
      _Page("日K", dailyKimgUrl),
      _Page("周K", weeklyKimgUrl),
      _Page("月K", monthlyKimgUrl),
    ];
